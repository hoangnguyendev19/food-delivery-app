...
import { getAllFood, resetFood } from '../store/foodSlice.js';
import { getAllFoodSale, resetFoodSale } from '../store/foodSaleSlice.js';
...
const Home = () => {
  ...
  const foodSale = useSelector((state) => state.foodSale);

  useEffect(() => {
    dispatch(getAllFood({ category }));
    dispatch(getAllFoodSale());
    dispatch(resetFood());
    dispatch(resetFoodSale());
  }, [dispatch, category]);
              ...
              <Row>
                ...
                {foodList.isLoading ? (
                  ...
                  foodList.allFood?.foods.map((item) => (
                    <Col lg="3" md="4" sm="6" xs="12" key={item._id} className="mt-4">
            ...
            <Container>
              <Row>
                ...
                {foodSale.isLoading ? (
                  ...
                  foodSale.allFoodSale?.foods.map((item) => (
                    <Col lg="3" md="4" sm="6" xs="12" key={item._id} className="mt-4">
                      <ProductCard item={item} />
                    </Col>
                  ))
