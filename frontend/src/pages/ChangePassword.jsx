...
import { resetState, updatePassword } from '../store/userDetailSlice';
...
const ChangePassword = () => {
  ...
  const { isLoading, isError, message, isSuccess } = useSelector((state) => state.userDetail);
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      await dispatch(updatePassword(passwordObj));
      resetForm();
    },
  });
